...
public class IGC_GuestUsing3DVisaInUK extends spafinder.com.base.UKBaseClass  {
...
@Test
public void IGC_GuestUserUsing3D_inUK () throws InterruptedException, IOException{
...
// Billing page
	...
	setCellData ("UK", "OrderNumber", 9, gcl.orderNumber); // Writing order number into excel file.
	System.out.println(getCellData("UK", "OrderNumber", 9)); // reading from excel
	
	passData ("UK", "Total", 9, totalAmount);
	System.out.println ("Total Price is: " + totalAmount);
	passData ("UK", "passFail", 9, gcv.Pass); // writing the text into excel from selenium
	System.err.println ("=====================================================================");
		}
    screenShot ("3D_UK_ExistingUser");
	}
}
}