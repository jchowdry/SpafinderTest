...
public class Classic_ExistingUserUsingPromoInUK extends spafinder.com.base.UKBaseClass  {
...
@Test
public void ClassicUserPromoInUK () throws InterruptedException, IOException{
...
// Billing page
	    ...
	    if (PF == false)
	    {
	    	passData ("Order", "passFail", 15, cv.Fail); // writing the text into excel from selenium
	    } else  { 
	    	passData ("UK", "passFail", 15, cv.Pass); // writing the text into excel from selenium
	    	setCellData ("UK", "OrderNumber", 15, cl.orderNumber); // Writing UK number into excel file.
	    	System.out.println(getCellData("UK", "OrderNumber", 15)); // reading from excel\

	    	passData ("UK", "Total", 15, totalAmount);
	    	System.out.println ("Total Price is: " + totalAmount);
	    	System.err.println ("=====================================================================");	
				}
		   	}
		  }
		screenShot ("Promo_ukClassicUSER");
	}	
}